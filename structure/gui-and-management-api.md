...
A [zero-byte HTTP recovery](transports/streaming-health.md#zero-byte-http-stream-recovery) records its physical send as `connection-reset`; logs do not include the failed refetch response body.

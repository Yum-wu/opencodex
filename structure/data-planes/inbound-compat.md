...
Native Chat preserves terminal/cancellation precedence during [zero-byte HTTP recovery](../transports/streaming-health.md#zero-byte-http-stream-recovery); partial output is never replayed.

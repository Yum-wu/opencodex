...
[Zero-byte HTTP recovery](../transports/streaming-health.md#zero-byte-http-stream-recovery) is request-local; it starts no service timer and does not change sidecar-owned retry policies.

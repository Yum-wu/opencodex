...
Native xAI Responses uses the shared [zero-byte HTTP recovery](../transports/streaming-health.md#zero-byte-http-stream-recovery) without bypassing the selected OAuth binding or refreshing a new account after headers.

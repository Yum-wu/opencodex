...
Model selection is not repeated by [zero-byte HTTP recovery](transports/streaming-health.md#zero-byte-http-stream-recovery); the selected request and its existing allowance remain authoritative.

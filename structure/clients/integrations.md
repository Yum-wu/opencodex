...
Client configuration writers remain separate from [zero-byte HTTP stream recovery](../transports/streaming-health.md#zero-byte-http-stream-recovery), which changes only an eligible in-flight body reader.
